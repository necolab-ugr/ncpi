...
# Get the ncpi folder path
ncpi_path = os.path.join(current_dir, '..', '..', 'ncpi')
sys.path.append(ncpi_path)
# Import ncpi/tools.py as file, not as the Python package
...
# @tools.timer("Computing features from empirical data.") # If function "timer" is already in the ncpi Python package
...
# @tools.timer("Computing predictions from empirical data.") # If function "timer" is already in the ncpi Python package
