(() => {
    ...
    const helpByKey = {
        ...
        parser_zscore: "Enable z-score normalization by subtracting the mean and dividing by the population standard deviation. Then use Z-score timing to choose whether the selected continuous signal is standardized once before epoching or each generated epoch is standardized independently after epoching.",
        parser_zscore_after_epoch: "Choose when enabled z-score normalization is applied. Before epoching standardizes the selected continuous signal once, so all generated epochs share one normalization reference. After epoching standardizes every generated epoch independently.",
