...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (elements.container) {
        const _refreshOnPopulationControlEdit = (event) => {
        ...
        elements.container.addEventListener('input', _refreshOnPopulationControlEdit);
        elements.container.addEventListener('change', _refreshOnPopulationControlEdit);
    }
