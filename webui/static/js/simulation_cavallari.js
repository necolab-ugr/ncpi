...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function populationName(index) {
        const names = getPopulationNames();
    ...
    if (elements.container) {
        const refreshOnPopulationControlEdit = (event) => {
            ...
            if ((row.dataset.paramName || '') === 'X') {
                refreshLeafLabels();
            }
        };
        elements.container.addEventListener('input', refreshOnPopulationControlEdit);
        elements.container.addEventListener('change', refreshOnPopulationControlEdit);
    }
