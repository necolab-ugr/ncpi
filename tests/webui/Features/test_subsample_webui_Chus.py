...
def run(playwright: Playwright) -> None:
    ...
    expect(page.get_by_role("button", name="Compute features arrow_forward")).to_be_visible(timeout= 2000000)
    page.get_by_role("button", name="Compute features arrow_forward").click(timeout= 900000)
