...
# Expected average 
expected_avg = 5.119589634869177
...
def run(playwright: Playwright) -> None:
    ...
    navigate_and_select(page, "/DATOS/pablomc/empirical_datasets/Krukow_data/Task-Related signals/ShortBlock_Band_1-70/Band_1-70")
